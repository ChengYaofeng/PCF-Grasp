...
def get_args():
    ...
    parser.add_argument('--config', type=str, default='~/pcf_grasp/pcfgrasp_method/', help='Checkpoint dir')
    ...
    parser.add_argument('--output_path', type=str, default='~/pcf_grasp/pcfgrasp_method/checkpoints', help='expariment name')
