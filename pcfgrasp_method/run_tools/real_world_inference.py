    ...
    try:
        while True:
            ...
            if key & 0xFF == ord(' '):
                ...
                args.config_file = '~/PCG-Grasp/pcfgrasp_method/detectron2/configs/COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_dir', type=str, default='~/PCG-Grasp/pcfgrasp_method/')

    #mask-rcnn
    parser.add_argument('--config_file', metavar="FILE", default='~/PCG-Grasp/pcfgrasp_method/detectron2/configs/COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml')
