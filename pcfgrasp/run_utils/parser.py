...
def get_args():
    ...
    parser.add_argument('--config', type=str, default='~/6d_grasp/completion_method/', help='Checkpoint dir')
    ...
    parser.add_argument('--output_path', type=str, default='/home/cyf/6d_grasp/completion_method/checkpoints', help='expariment name')
...
def create_experiment_dir(args):
    ...
    # parser.add_argument('--pretrain_cfg', default='~/6d_grasp/completion_method/cfgs/', type=str, help='pretrain config yaml file path')
