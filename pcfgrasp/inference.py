...
import os
import sys
BASE_DIR = os.path.dirname(os.path.abspath(__file__)) #/home/cyf/6d_grasp/completion_method
# print(BASE_DIR)
...
def main(args):
    ...
    if args.pretrain_vis is True:
        ...
        data_set = CompleteDataset(global_config, pcreader, contact_infos, split='train')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default=None, help='train_inference picture pcd scene or object waiting for grasp generation') #'/home/cyf/contact_graspnet/test_data/*.npy'
    ...
    #mask-rcnn
    parser.add_argument('--config_file', metavar="FILE", default='/home/cyf/6d_grasp/completion_method/mask_rcnn/configs/COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml')
