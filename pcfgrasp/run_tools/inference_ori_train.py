...
from utils.data import PointCloudReader, preprocess_pc_for_inference
...
def ori_train_inference(args, global_config, data_set=None, K=None, z_range=[0.2, 1.8] ,forward_passes=1):
    ...
    for _, data in enumerate(eval_dataloader):
        ...
        pred_grasps_cam, scores, contact_pts, _ = grasp_estimatior.predict_scene_grasps(pc, args, obj_pc, forward_passes=forward_passes)
        visualize_grasps(pc, obj_pc, pred_grasps_cam, scores, plot_opencv_cam=True)
